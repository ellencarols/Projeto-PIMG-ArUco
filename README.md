...
Detectar e Localizar precisamente a região preta de um marcador ArUco em imagens.
Determinar a Orientação do marcador analisando a posição relativa de textos próximos.
Corrigir a Rotação da imagem para garantir que o texto associado ao ArUco esteja sempre alinhado abaixo dele.
Remover Seletivamente o Texto ao redor do marcador, isolando e preservando apenas o ArUco na imagem final.
...
Detecção do Marcador ArUco (Orientação):
...
Análise e Correção de Orientação:
